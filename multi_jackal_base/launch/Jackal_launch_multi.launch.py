...
cli_args = ['/home/user/catkin_ws/src/jackal-swarm-addition/multi_jackal_base/launch/jackal_gazebo.launch']
...
for num in range(0, int(sys.argv[1])):
    cli_args = ['/home/user/catkin_ws/src/jackal-swarm-addition/multi_jackal_base/launch/base_jackal.launch',
